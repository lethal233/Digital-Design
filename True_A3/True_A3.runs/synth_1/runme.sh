...
HD_PWD='C:/Users/Lori/DigitalDesign/True_A3/True_A3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log task1_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source task1_wrapper.tcl
