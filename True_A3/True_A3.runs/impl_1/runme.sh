...
HD_PWD='C:/Users/Lori/DigitalDesign/True_A3/True_A3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log task1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source task1_wrapper.tcl -notrace
