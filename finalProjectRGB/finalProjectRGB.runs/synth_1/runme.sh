...
HD_PWD='C:/Users/Lori/DigitalDesign/finalProjectRGB/finalProjectRGB.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log colorLumpOutput.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source colorLumpOutput.tcl
