...
HD_PWD='C:/Users/Lori/DigitalDesign/finalProjectRGB/finalProjectRGB.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log colorLumpOutput.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source colorLumpOutput.tcl -notrace
