...
HD_PWD='C:/Users/Lori/DigitalDesign/colorLump/colorLump.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log colorlump.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source colorlump.tcl
