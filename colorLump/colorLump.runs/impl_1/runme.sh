...
HD_PWD='C:/Users/Lori/DigitalDesign/colorLump/colorLump.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log colorlump.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source colorlump.tcl -notrace
