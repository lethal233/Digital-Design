...
HD_PWD='C:/Users/Lori/DigitalDesign/resolution/resolution.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log display_segtube.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source display_segtube.tcl -notrace
