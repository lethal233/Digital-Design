...
HD_PWD='C:/Users/Lori/DigitalDesign/resolution/resolution.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log display_segtube.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source display_segtube.tcl
