...
HD_PWD='C:/Users/Lori/DigitalDesign/A5T1/A5T1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sp_converter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sp_converter.tcl -notrace
