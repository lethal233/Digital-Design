...
HD_PWD='C:/Users/Lori/DigitalDesign/A5T1/A5T1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sp_converter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sp_converter.tcl
