...
HD_PWD='C:/Users/Lori/DigitalDesign/True_A3-2/True_A3-2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BCD_to_seven.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BCD_to_seven.tcl
