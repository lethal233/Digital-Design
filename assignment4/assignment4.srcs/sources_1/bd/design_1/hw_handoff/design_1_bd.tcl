...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net D_1 [get_bd_ports D] [get_bd_pins util_vector_logic_4/Op1] [get_bd_pins util_vector_logic_8/Op1]
  connect_bd_net -net En_1 [get_bd_ports En] [get_bd_pins util_vector_logic_4/Op2] [get_bd_pins util_vector_logic_7/Op1]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins util_vector_logic_0/Res] [get_bd_pins util_vector_logic_1/Op1]
  connect_bd_net -net util_vector_logic_1_Res [get_bd_ports Q] [get_bd_pins util_vector_logic_1/Res] [get_bd_pins util_vector_logic_2/Op1]
  connect_bd_net -net util_vector_logic_2_Res [get_bd_pins util_vector_logic_2/Res] [get_bd_pins util_vector_logic_3/Op1]
  connect_bd_net -net util_vector_logic_3_Res [get_bd_ports Qn] [get_bd_pins util_vector_logic_0/Op2] [get_bd_pins util_vector_logic_3/Res]
  connect_bd_net -net util_vector_logic_4_Res [get_bd_pins util_vector_logic_4/Res] [get_bd_pins util_vector_logic_5/Op1]
  connect_bd_net -net util_vector_logic_5_Res [get_bd_pins util_vector_logic_0/Op1] [get_bd_pins util_vector_logic_5/Res]
  connect_bd_net -net util_vector_logic_6_Res [get_bd_pins util_vector_logic_2/Op2] [get_bd_pins util_vector_logic_6/Res]
