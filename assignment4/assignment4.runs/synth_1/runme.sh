...
HD_PWD='C:/Users/Lori/DigitalDesign/assignment4/assignment4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log T_FF.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source T_FF.tcl
