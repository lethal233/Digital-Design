...
HD_PWD='C:/Users/Lori/DigitalDesign/assignment4/assignment4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log T_FF.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source T_FF.tcl -notrace
