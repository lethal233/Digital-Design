...
HD_PWD='C:/Users/Lori/DigitalDesign/A1T2/A1T2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log demorgan_bd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source demorgan_bd_wrapper.tcl -notrace
